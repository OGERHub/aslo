...
Zur nahtlosen Nutzung ist es hilfreich einen entsprchenden Editor zu verwenden. Insbesondere `RStudio` bietet eine nahtlose Integration von `Quarto`.
...
Kopieren Sie dieses Template beginnend mit den drei Bindestrichen bis zum Ende und fügen Sie es in das Editierfenster einer der Markdown-Editoren ein, speichern Sie es
