...
Der fertige Artikel ist als PDF/QMD-Dokument bis spätestens:: **30.09.2024** um **23:55 Uhr** in den entsprechenden Abgabe-Ordner auf [ILIAS](https://ilias.uni-marburg.de/ilias.php?) hochzuladen und in folgender Form zu benennen:

*Aslo_Name_Name_Name.pdf* (Bsp.: Aslo_Hinz_Kunz_Meier.<pdf><qmd><zip>) <br> <br> Genaue Arbeitsanweisungen zu den Übungsaufgaben finden Sie hier im Lernmodul. <br>
