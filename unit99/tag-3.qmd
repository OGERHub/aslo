...
Ein Rückgriff auf vorhandenes Wissen ist notwendig, allerdings können 
alte Lösungsstrategienzu kurz greifen. Die Verbindung verschiedener Ansätze und Entwicklung von Neuem ist erforderlich (vgl. @abercrombie2023training, @RickardsEtAl2024).
...
Durch Kommunikation mit gesellschaftspolitischen Akteur:innen kann die Tendenz zur  Übersimplifizierung vermieden werden. Viele fordern Akteur:innen allerdings Planungssicherheit, die Änderungen und Innovation erschweren (vgl. @RickardsEtAl2024). 
...
Was bedeutet das für die Exkursion?
  ...
  - welches gesellschaftspolitische Engagement erscheint für erfolgreiche Adaptionsmassnahmen sinnvoll?
...
```{mermaid}
flowchart TB
    Begriffe_klären(("Begriffe klären")) --> Problem_beschreiben(("Problem beschreiben"))
    Problem_beschreiben --> Brainstorming(("Brainstorming"))
    Brainstorming --> Strukturieren_Ordnung(("Strukturieren & Ordnung"))
    Strukturieren_Ordnung --> Lernziele_formulieren(("Lernziele formulieren"))
    Lernziele_formulieren --> Recherchephase(("Recherchephase"))
    Recherchephase --> Ergebnisse_zusammenführen(("Ergebnisse zusammenführen"))
    Ergebnisse_zusammenführen --> Reflexion_Anwendung(("Reflexion & Anwendung"))
    Reflexion_Anwendung -.-> Begriffe_klären

    style Begriffe_klären fill:#f9f,stroke:#333,stroke-width:2px
    style Problem_beschreiben fill:#f9f,stroke:#333,stroke-width:2px
    style Brainstorming fill:#bbf,stroke:#333,stroke-width:2px
    style Strukturieren_Ordnung fill:#bbf,stroke:#333,stroke-width:2px
    style Lernziele_formulieren fill:#bfb,stroke:#333,stroke-width:2px
    style Recherchephase fill:#bfb,stroke:#333,stroke-width:2px
    style Ergebnisse_zusammenführen fill:#fbb,stroke:#333,stroke-width:2px
    style Reflexion_Anwendung fill:#fbb,stroke:#333,stroke-width:2px
