...
Sie können Ihren Beitrag entweder als Word-Dokument oder als Markdown-Dokument einreichen (in beiden Fällen bitte im Ilias-Ordner). Wenn Sie Ihren Beitrag in Markdown einreichen, werden wir ihn auf dieser Homepage veröffentlichen, um eine konkrete Nutzung zu ermöglichen. Unter [Ressourcen](../unit02/unit02-02.qmd) finden Sie eine Vorlage, die Sie verwenden können, wenn Ihr Beitrag veröffentlicht werden soll und Sie gleichzeitig Ihre digitalen Kompetenzen weiterentwickeln möchten. Im folgenden wird der Praxisbeitrag näher erläutert.
