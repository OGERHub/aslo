...
Wir möchten dass Sie Ihren Beitragf als Markdown-Dokument einreichen (bitte im Ilias-Ordner). Sie können daraus ein nahezu beliebiges Dokumentformat erzeugen. Wir möchten Ihren Beitrag auf dieser Homepage veröffentlichen, um eine reale Nutzung für Marburger Lehrkräfte zu ermöglichen. Unter [Ressourcen](../unit02/unit02-02.qmd) finden Sie eine Vorlage, die Sie verwenden können. Bitte beachten Sie auch wenn es eine kleine Hürde ist sich mit MArkdown Dokumenten auseinenaderzusetzen erhöht es gleichzeitig Ihre digitalen Kompetenzen enorm. Im folgenden wird der Praxisbeitrag näher erläutert.
